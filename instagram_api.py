...
def inst(after_value, user_id):
    params = (
        ('query_hash', 'c76146de99bb02f6415203be841dd25a'),
        (
            'variables',
            f'{{"id":"{user_id}","include_reel":true,"fetch_mutual":false,"first":50{after_value}}}'
        ),
    )
...
def get_followers_count(user_id):
    ...
    while True:
        ...
        json_result = inst(after_value, user_id)
...
if __name__ == "__main__":
    get_followers_count(21292670370)
